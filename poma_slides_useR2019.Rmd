...
## Aims
  ...
  - Make a completely <span style="color:#f38620">**REPLICABLE**</span> analysis (Open Source)
  
  - **Our main aim is <span style="color:#f38620">COMPLETE</span> and give other option to users, <span style="color:#f38620">NOT</span> to <span style="color:#f38620">COMPETE</span> with the extisting tools**
...
<img src="pix/meme.jpg" width="300">
